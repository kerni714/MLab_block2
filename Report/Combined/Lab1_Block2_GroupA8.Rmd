...
correspond to a split along each of $X1$ and $X2$, rather than a combination of the two as in dataset 1, as decision trees makes splits in the data using one variable at a time. (although it is not obvious how it finds those splits as $X1$ and $X2$ have uniform distributions).
